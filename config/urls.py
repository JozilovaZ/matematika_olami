...
urlpatterns = [
    ...
    # O'qituvchi paneli
    path('oqituvchi/', views.oqituvchi_panel, name='oqituvchi_panel'),

    # Kategoriyalar
    path('oqituvchi/kategoriyalar/', views.oqituvchi_kategoriyalar, name='oqituvchi_kategoriyalar'),
    ...
    # Mavzular
    path('oqituvchi/mavzular/', views.oqituvchi_mavzular, name='oqituvchi_mavzular'),
    ...
    # Darslar
    path('oqituvchi/darslar/', views.oqituvchi_darslar, name='oqituvchi_darslar'),
    ...
    # Topshiriqlar
    path('oqituvchi/topshiriqlar/', views.oqituvchi_topshiriqlar, name='oqituvchi_topshiriqlar'),
    ...
    # Musobaqalar
    path('oqituvchi/musobaqalar/', views.oqituvchi_musobaqalar, name='oqituvchi_musobaqalar'),
